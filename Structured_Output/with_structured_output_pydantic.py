...
class Review(BaseModel):
    ...
    sentiment: Literal['pos', 'neg'] = Field(description= "Return Senitment of review either negative, positive or neutral") 
    ...
    # sentiment:Annotated[Literal["pos", "neg"], "Return Senitment of review either negative, positive or neutral"]
